    ...
    <footer className={styles.footer}>
      <div className={styles.footer__actions}>
        <div className={styles.footer__button}>
          <FooterButton to={`/cinema/today`} IconActive={<MovieActiveIcon/>} IconNotActive={<MovieNotActiveIcon/>} text='Афиша' />
        </div>
        <div className={styles.footer__button}>
          <FooterButton to={`/cinema/orders`} IconActive={<TicketActiveIcon/>} IconNotActive={<TicketNotActiveIcon/>} text='Билеты' />
        </div>
        <div className={styles.footer__button}>
          <FooterButton to={`/cinema/users/profile`} IconActive={<UserActiveIcon/>} IconNotActive={<UserNotActiveIcon/>} text='Профиль' />
        </div>
      </div>
    </footer>
  )
